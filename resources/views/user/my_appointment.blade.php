...
<head>
  ...
  <title>MRS Hospital Bangladesh</title>
...
<body>
  ...
  <header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +880 1767788331</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span> musfiqur521@gmail.com</a>
            </div>
          </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary">MRS</span>-Hospital</a>
    ...
    <div align="center" style="padding: 70px;">
        <table>
            ...
            <tr style="background-color: #98FB98;" align="center">
                ...
                <td>
                    <a class="bt btn-danger" onclick="return confirm('are you sure to delete this')" href="{{url('cancel_appoint', $appoints->id)}}">Cancel</a>
                </td>
